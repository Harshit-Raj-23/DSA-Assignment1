class DynamicArray:
    ...
    def reverse(self):
        ...
        while start < end:
            self.__array[start], self.__array[end] = self.__array[end], self.__array[start]
            start += 1
            end -= 1
    ...
    def rotateRight(self, k):
        if self.__size <= 1:
            return
        k %= self.__size
        self.__reverse(0, self.__size-1)
        self.__reverse(0, k-1)
        self.__reverse(k, self.__size-1)
